...
app.use( express.static( "views/monuments/images" ) );
...
app.use(fileUpload());
app.use('/views/monuments/images/', express.static('./views/monuments/images'));
...
app.get('/AnassMap', (req, res) => {
    ...
    app.post('/monuments/save', (req, res) => {
        ...
        let data = { id: req.body.id, nom: req.body.nom, latitude: req.body.latitude, longitude: req.body.longitude, ville: req.body.ville, img: teswira.name };
